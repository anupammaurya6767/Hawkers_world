        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap -mx-4 -mb-10 text-center">
            <div class="sm:w-1/2 mb-10 px-4">
              ...
              <Link href={"/usersignup"}><button class="flex text-2xl mx-auto mt-6 text-white bg-green-500 border-0 py-2 px-5 focus:outline-none hover:bg-green-600 rounded">Sign Up</button></Link>
            </div>
            <div class="sm:w-1/2 mb-10 px-4">
              <div class="rounded-lg h-64 overflow-hidden">
              ...
              <Link href={"/vendorsignup"}><button class="flex text-2xl mx-auto mt-6 text-white bg-green-500 border-0 py-2 px-5 focus:outline-none hover:bg-green-600 rounded">Sign Up</button></Link>
            </div>
          </div>
        </div>
      </section>
